...
public class ColorSpace {
    ...
    public static final int OBSERVER_2 = 0;
    public static final int OBSERVER_10 = 1;
    ...
    public static final int ILLUMINANT_E = 7;
    public static final int ILLUMINANT_F1 = 8;
    public static final int ILLUMINANT_F2 = 9;
    public static final int ILLUMINANT_F3 = 10;
    public static final int ILLUMINANT_F4 = 11;
    public static final int ILLUMINANT_F5 = 12;
    public static final int ILLUMINANT_F6 = 13;
    public static final int ILLUMINANT_F7 = 14;
    public static final int ILLUMINANT_F8 = 15;
    public static final int ILLUMINANT_F9 = 16;
    public static final int ILLUMINANT_F10 = 17;
    public static final int ILLUMINANT_F11 = 18;
    public static final int ILLUMINANT_F12 = 19;

    private double ref_x = 95.047;
    private double ref_y = 100;
    private double ref_z = 108.883;

    public void setTristimulus(int observer, int illuminant) {
    ...
    public CMYK toCMYK() {
        if (this instanceof RGB) {
            ...
            return (CMYK) this;
        } else if (this instanceof RYB) {
            return RGBtoCMYK(RYBtoRGB((RYB) this));
        ...
        } else if (this instanceof ARGB) {
            return RGBtoCMYK(XYZtoRGB(ARGBtoXYZ((ARGB) this)));
    ...
    public HSV toHSV() {
        if (this instanceof RGB) {
            ...
            return RGBtoHSV(RYBtoRGB((RYB) this));
        } else if (this instanceof HSV) {
            return (HSV) this;
        } else if (this instanceof HSL) {
            ...
            return RGBtoHSV(XYZtoRGB(ARGBtoXYZ((ARGB) this)));
        } else if (this instanceof CIELab) {
    ...
    public HSL toHSL() {
        if (this instanceof RGB) {
            ...
            return RGBtoHSL(RYBtoRGB((RYB) this));
        } else if (this instanceof HSV) {
            ...
            return RGBtoHSL(XYZtoRGB(ARGBtoXYZ((ARGB) this)));
        } else if (this instanceof CIELab) {
    ...
    public RGB toRGB() {
        if (this instanceof RGB) {
            ...
            return RYBtoRGB((RYB) this);
        } else if (this instanceof XYZ) {
            return XYZtoRGB((XYZ) this);
        } else if (this instanceof Yxy) {
            return XYZtoRGB(YxytoXYZ((Yxy) this));
        } else if (this instanceof ARGB) {
            return XYZtoRGB(ARGBtoXYZ((ARGB) this));
        } else if (this instanceof CIELab) {
    ...
    public RYB toRYB() {
        if (this instanceof RGB) {
            return RGBtoRYB((RGB) this);
        } else if (this instanceof CMYK) {
            return RGBtoRYB(CMYKtoRGB((CMYK) this));
        } else if (this instanceof RYB) {
            return (RYB) this;
        } else if (this instanceof HSV) {
            return RGBtoRYB(HSVtoRGB((HSV) this));
        } else if (this instanceof HSL) {
            return RGBtoRYB(HSLtoRGB((HSL) this));
        } else if (this instanceof XYZ) {
            return RGBtoRYB(XYZtoRGB((XYZ) this));
        } else if (this instanceof Yxy) {
            return RGBtoRYB(XYZtoRGB(YxytoXYZ((Yxy) this)));
        } else if (this instanceof ARGB) {
            return RGBtoRYB(XYZtoRGB(ARGBtoXYZ((ARGB) this)));
        } else if (this instanceof CIELab) {
            return RGBtoRYB(XYZtoRGB(CIELabtoXYZ((CIELab) this)));
        } else if (this instanceof CIELCH) {
            return RGBtoRYB(XYZtoRGB(CIELabtoXYZ(CIELCHtoCIELab((CIELCH) this))));
        } else if (this instanceof CIELuv) {
            return RGBtoRYB(XYZtoRGB(CIELuvtoXYZ((CIELuv) this)));
        } else if (this instanceof HunterLab) {
            return RGBtoRYB(XYZtoRGB(HunterLabtoXYZ((HunterLab) this)));
        }
        return null;
    }
    ...
    public ARGB toARGB() {
        if (this instanceof RGB) {
            return XYZtoARGB(RGBtoXYZ((RGB) this));
        } else if (this instanceof ARGB) {
            return (ARGB) this;
        } else if (this instanceof CMYK) {
            return XYZtoARGB(RGBtoXYZ(CMYKtoRGB((CMYK) this)));
        } else if (this instanceof RYB) {
            return XYZtoARGB(RGBtoXYZ(RYBtoRGB((RYB) this)));
        } else if (this instanceof HSV) {
            return XYZtoARGB(RGBtoXYZ(HSVtoRGB((HSV) this)));
        } else if (this instanceof HSL) {
            return XYZtoARGB(RGBtoXYZ(HSLtoRGB((HSL) this)));
        } else if (this instanceof XYZ) {
            return XYZtoARGB((XYZ) this);
        } else if (this instanceof Yxy) {
            return XYZtoARGB(YxytoXYZ((Yxy) this));
        } else if (this instanceof CIELab) {
            return XYZtoARGB(CIELabtoXYZ((CIELab) this));
        } else if (this instanceof CIELCH) {
            return XYZtoARGB(CIELabtoXYZ(CIELCHtoCIELab((CIELCH) this)));
        } else if (this instanceof CIELuv) {
            return XYZtoARGB(CIELuvtoXYZ((CIELuv) this));
        } else if (this instanceof HunterLab) {
            return XYZtoARGB(HunterLabtoXYZ((HunterLab) this));
        }
        return null;
    }
    ...
    public XYZ toXYZ() {
        if (this instanceof RGB) {
            ...
            return RGBtoXYZ(RYBtoRGB((RYB) this));
        } else if (this instanceof HSV) {
    ...
    public CIELab toCIELab() {
        if (this instanceof RGB) {
            ...
            return XYZtoCIELab(RGBtoXYZ(RYBtoRGB((RYB) this)));
        } else if (this instanceof HSV) {
            ...
            return XYZtoCIELab(ARGBtoXYZ((ARGB) this));
        } else if (this instanceof CIELab) {
            return (CIELab) this;
        } else if (this instanceof CIELCH) {
    ...
    public CIELCH toCIELCH() {
        if (this instanceof RGB) {
            ...
            return CIELabtoCIELCH(XYZtoCIELab(RGBtoXYZ(RYBtoRGB((RYB) this))));
        } else if (this instanceof HSV) {
            ...
            return CIELabtoCIELCH(XYZtoCIELab(ARGBtoXYZ((ARGB) this)));
        } else if (this instanceof CIELab) {
    ...
    public Yxy toYxy() {
        if (this instanceof RGB) {
            ...
            return XYZtoYxy(RGBtoXYZ(RYBtoRGB((RYB) this)));
        } else if (this instanceof HSV) {
            ...
            return XYZtoYxy(ARGBtoXYZ((ARGB) this));
        } else if (this instanceof CIELab) {
    ...
    public CIELuv toCIELuv() {
        if (this instanceof RGB) {
            ...
            return XYZtoCIELuv(RGBtoXYZ(RYBtoRGB((RYB) this)));
        } else if (this instanceof HSV) {
            ...
            return XYZtoCIELuv(ARGBtoXYZ((ARGB) this));
        } else if (this instanceof CIELab) {
    ...
    public HunterLab toHunterLab() {
        if (this instanceof RGB) {
            ...
            return XYZtoHunterLab(RGBtoXYZ(RYBtoRGB((RYB) this)));
        } else if (this instanceof HSV) {
            ...
            return XYZtoHunterLab(ARGBtoXYZ((ARGB) this));
        } else if (this instanceof CIELab) {
    ...
    private  RYB RGBtoRYB (RGB rgb){
        // remove the whiteness from the color
        double w = Math.min(Math.min(rgb.R, rgb.G), rgb.B);
        double r = rgb.R - w;
        double g = rgb.G - w;
        double b = rgb.B - w;
    ...
    private RGB RYBtoRGB (RYB ryb){

        double w = Math.min(Math.min(ryb.R, ryb.Y), ryb.B);
        double r = ryb.R - w;
        double y = ryb.Y - w;
        double b = ryb.B - w;
    ...
    private XYZ ARGBtoXYZ(ARGB argb) {

        double var_R = (argb.R / 255);
        double var_G = (argb.G / 255);
        double var_B = (argb.B / 255);
        ...
        double X = var_R * 0.57667 + var_G * 0.18556 + var_B * 0.18823;
        double Y = var_R * 0.29734 + var_G * 0.62736 + var_B * 0.07529;
        double Z = var_R * 0.02703 + var_G * 0.07069 + var_B * 0.99134;

        return new XYZ(X, Y, Z);
    }

    private ARGB XYZtoARGB(XYZ xyz) {

        double var_X = xyz.X / 100;
        double var_Y = xyz.Y / 100;
        double var_Z = xyz.Z / 100;

        double var_R = var_X * 2.04159 + var_Y * -0.56501 + var_Z * -0.34473;
        double var_G = var_X * -0.96924 + var_Y * 1.87597 + var_Z * 0.03342;
        double var_B = var_X * 0.01344 + var_Y * -0.11836 + var_Z * 1.34926;


        var_R = Math.pow(var_R, (1 / 2.19921875));
        var_G = Math.pow(var_G, (1 / 2.19921875));
        var_B = Math.pow(var_B, (1 / 2.19921875));
